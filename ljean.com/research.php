...
<br>
<br>
    Kevin Beton,  L Jean Camp &amp; Chris Small, <a href="http://www.ljean.org/files/vulnerability_analysis.pdf"><q>OpenFlow Vulnerability Assessment</q></a>, HotSDN, August 2013, Hong Kong.  Extended abstract.


<br>
<br>Security as Risk<br>
<A href= "http://www.ljean.com/files/riskPosted.pdf"><b>Computer Security is Risk Communication</b></a><br>
<em>Want Technically Naive People to Adopt Security Technology? Talk to them in their own terms...<br></em>
Individual security solutions have not been adopted even when individuals have expressed their desire to do so. Our experiment suggests one contributing factor is that the rich array of metaphors used by computer security professionals fail to align with individual's mental models. Speaking of <q>phishing</q>, <q>worms</q>, and <q>infections</q> is not helpful risk communication.
<br><br>
...
<br>
Keylogger - <A href="http://www.youtube.com/watch?v=6zHJoZqrCB0">http://www.youtube.com/watch?v=6zHJoZqrCB0</a>
<br>
Phishing -<A href=" http://www.youtube.com/watch?v=4ZQ9pFTCdy4"> http://www.youtube.com/watch?v=4ZQ9pFTCdy4</a>
<br>
To reference please use either<br>
L. Jean Camp, <q>Mental models of privacy and security</q> IEEE Technology
And Society Magazine (2009) No 3:28,  IEEE, Pages: 37-46.
<br>or<br>
J. Blythe, L. Jean Camp &amp; V. Garg, <q>Targeted risk Communication for Computer Security</q>, 2011 International Conference on Intelligent User Interfaces, (Palo Alto, CA) 13-16 February 2011.<A href=http://portal.acm.org/citation.cfm?id=1943449&preflayout=tabs>From the ACM portal</a><br>
<br>
<br>
<em>Incentive-Based Access Control</em>
Working with doctoral graduate <A href="http://liu-debin.com/" >Debin Liu</a> we have first paper on incentive-based access control, entitled <A href="http://fc09.ifca.ai/papers/87_Mitigating_inadvertent.pdf">Mitigating Inadvertent Insider Threas</a>. <q>Future work</q> from this paper now <q>work in progress</q>.
<br><br>
<em><A href=NetTrust/>Net Trust: Defeating Social Engineering</a></em><br>
Description:<em><A href="http://www.youtube.com/watch?v=IGBKI1QBAr8">The Tech Talk Overview</a></em> describes how Net Trust works. Current trust mechanisms are built for computers, not humans, despite the reams of available research on human trust decisions. In fact, the most common trust devices (e.g., seals, domain names) require the cooperation of the malicious to function. We have developed  a system to use social networks to inform trust decisions. Initial users tests show that Net Trust alters trust behaviors, providing information to people that makes them more trusting of some sites and less trusting of others.
</font>

Alex Tsow, Camilo Viecco, and L. Jean Camp, <q>Privacy-Aware Architecture for Sharing Web Histories</q>, IBM Journal of Research &amp; Development - or - L. Jean Camp, <q>Reliable, Usable Signaling to Defeat Masquerade Attacks</q>, IS A Journal of Law and Policy in the Information Society, 2007, Vol. 3, No 2: 211-235. <br>
Private social networking, information-sharing with security; perfect forward secrecy after de-friending; highly customized interactions<br><br>
<br>
<br>
<em><A href="http://www.ljean.com/files/IPv6Policies.pdf">IPv6</a><br></em>
...
<br>
<br>
<br>Experimentation<br>
<em>Want Security? Build Privacy.<br></em>
There is some question as to why end users do not adopt security technologies. We argue that this is typical of users to behave as human beings in the domain of risk and uncertainty. That is, there are consistent biases that determine if risks are acceptable or not. Responses to risk are determined more by the perception of benevolence of the creator of the risk than by the magnitude of the risk.  Here is <A href=files/MTW06camp.pdf>Trust on the Web, a Tale of User Deceit</a>.
<br>
<br>
<br>
<br>
